...
VimeoVideoConfig vimeoModelFromJson(String str) => VimeoVideoConfig.fromJson(json.decode(str));
...
class VimeoEmbed {
  ...
  factory VimeoEmbed.fromJson(Map<String, dynamic> json) => VimeoEmbed(
        ...
        settings: Map.from(json["settings"]).map((k, v) => MapEntry<String, int>(k, v)),
        color: json["color"],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "settings": settings != null ? Map.from(settings!).map((k, v) => MapEntry<String, dynamic>(k, v)) : null,
        "color": color,
        "texttrack": texttrack,
        "on_site": onSite,
        "app_id": appId,
...
class VimeoRequest {
  ...
  factory VimeoRequest.fromJson(Map<String, dynamic> json) => VimeoRequest(
        ...
        lang: json["lang"],
        sentry: json["sentry"] == null ? null : VimeoSentry.fromJson(json["sentry"]),
        thumbPreview: json["thumb_preview"] == null ? null : VimeoThumbPreview.fromJson(json["thumb_preview"]),
        referrer: json["referrer"],
        cookieDomain: json["cookie_domain"],
        timestamp: json["timestamp"],
        gcDebug: json["gc_debug"] == null ? null : VimeoGcDebug.fromJson(json["gc_debug"]),
        expires: json["expires"],
        client: json["client"] == null ? null : VimeoClient.fromJson(json["client"]),
        currency: json["currency"],
        session: json["session"],
        cookie: json["cookie"] == null ? null : VimeoCookie.fromJson(json["cookie"]),
        build: json["build"] == null ? null : VimeoBuild.fromJson(json["build"]),
        urls: json["urls"] == null ? null : VimeoUrls.fromJson(json["urls"]),
        signature: json["signature"],
        flags: json["flags"] == null ? null : VimeoFlags.fromJson(json["flags"]),
        country: json["country"],
        fileCodecs: json["file_codecs"] == null ? null : VimeoFileCodecs.fromJson(json["file_codecs"]),
        abTests: json["ab_tests"] == null ? null : VimeoAbTests.fromJson(json["ab_tests"]),
      );
...
class VimeoAbTests {
  ...
  factory VimeoAbTests.fromJson(Map<String, dynamic> json) => VimeoAbTests(
        chromecast: json["chromecast"] == null ? null : VimeoChromecast.fromJson(json["chromecast"]),
        statsFresnel: json["stats_fresnel"] == null ? null : VimeoChromecast.fromJson(json["stats_fresnel"]),
        llhlsTimeout: json["llhls_timeout"] == null ? null : VimeoChromecast.fromJson(json["llhls_timeout"]),
        webvr: json["webvr"] == null ? null : VimeoChromecast.fromJson(json["webvr"]),
        cmcd: json["cmcd"] == null ? null : VimeoChromecast.fromJson(json["cmcd"]),
      );

  VimeoChromecast? chromecast;
  VimeoChromecast? statsFresnel;
  VimeoChromecast? llhlsTimeout;
  VimeoChromecast? webvr;
...
class VimeoChromecast {
  ...
  factory VimeoChromecast.fromJson(Map<String, dynamic> json) => VimeoChromecast(
        track: json["track"],
        data: json["data"] == null ? null : VimeoData.fromJson(json["data"]),
        group: json["group"],
      );
...
class VimeoFileCodecs {
  ...
  factory VimeoFileCodecs.fromJson(Map<String, dynamic> json) => VimeoFileCodecs(
...
class VimeoFiles {
  ...
  factory VimeoFiles.fromJson(Map<String, dynamic> json) => VimeoFiles(
        dash: json["dash"] == null ? null : VimeoDash.fromJson(json["dash"]),
        hls: json["hls"] == null ? null : VimeoHls.fromJson(json["hls"]),
        progressive: json["progressive"] == null ? null : List<VimeoProgressive>.from(json["progressive"].map((x) => VimeoProgressive.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        "dash": dash?.toJson(),
        "hls": hls?.toJson(),
        "progressive": progressive != null ? List<dynamic>.from(progressive!.map((x) => x?.toJson())) : null,
      };
}
...
class VimeoDash {
  ...
  factory VimeoDash.fromJson(Map<String, dynamic> json) => VimeoDash(
        ...
        streams: json["streams"] == null ? [] : List<VimeoStream>.from(json["streams"].map((x) => VimeoStream.fromJson(x))),
        cdns: VimeoCdns.fromJson(json["cdns"]),
        streamsAvc: json["streams_avc"] == null ? [] : List<VimeoStream>.from(json["streams_avc"].map((x) => VimeoStream.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "streams": streams != null ? List<dynamic>.from(streams!.map((x) => x?.toJson())) : null,
        "cdns": cdns?.toJson(),
        "streams_avc": streamsAvc != null ? List<dynamic>.from(streamsAvc!.map((x) => x?.toJson())) : null,
...
class VimeoCdns {
  ...
  factory VimeoCdns.fromJson(Map<String, dynamic> json) => VimeoCdns(
        akamaiLive: VimeoAkamaiLive.fromJson(json["akamai_live"] ?? {}),
        fastlyLive: VimeoAkamaiLive.fromJson(json["fastly_live"] ?? {}),
        akfireInterconnectQuic: VimeoAkfireInterconnectQuic.fromJson(json["akfire_interconnect_quic"] ?? {}),
        fastlySkyfire: VimeoAkfireInterconnectQuic.fromJson(json["fastly_skyfire"] ?? {}),
      );

  VimeoAkamaiLive? akamaiLive;
  VimeoAkamaiLive? fastlyLive;
  ...
  Map<String, dynamic> toJson() => {
        ...
        "akamai_live": akamaiLive?.toJson(),
        "fastly_live": fastlyLive?.toJson(),
      };
}

class VimeoAkamaiLive {
  VimeoAkamaiLive({
    this.url,
    this.origin,
    this.jsonUrl,
  ...
  factory VimeoAkamaiLive.fromJson(Map<String, dynamic> json) => VimeoAkamaiLive(
        url: json["url"],
        origin: json["origin"],
...
class VimeoAkfireInterconnectQuic {
  ...
  factory VimeoAkfireInterconnectQuic.fromJson(Map<String, dynamic> json) => VimeoAkfireInterconnectQuic(
        url: json["url"],
        origin: json["origin"],
        avcUrl: json["avc_url"],
      );
...
class VimeoThumbPreview {
  ...
  factory VimeoThumbPreview.fromJson(Map<String, dynamic>? json) => VimeoThumbPreview(
        url: json?["url"],
...
class VimeoVideo {
  ...
  VimeoVideo.fromJson(dynamic json) {
    rating = json['rating'] != null ? VimeoRating.fromJson(json['rating']) : null;
    version = json['version'] != null ? VimeoVersion.fromJson(json['version']) : null;
    height = json['height'];
    duration = json['duration'];
    thumbs = json['thumbs'] != null ? VimeoThumbs.fromJson(json['thumbs']) : null;
